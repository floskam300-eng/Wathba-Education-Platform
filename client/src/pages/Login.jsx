...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const { device_id: deviceId, origin: deviceOrigin, device_name: deviceName, hardware_profile: hardwareProfile, hardware_hash: hardwareHash } = await getOrCreateDeviceId();
      const { user, force_password_change, is_new_device } = await login(
        username.trim(), password, undefined, undefined, deviceId, deviceOrigin, deviceName, hardwareProfile, hardwareHash
      );
