...
import { Smartphone, RotateCw, Play, Maximize2, ArrowRight } from 'lucide-react';
...
export default function GameLauncherPage() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black flex items-center justify-center overflow-hidden touch-none select-none">
      {/* ── FORCED LANDSCAPE ORIENTATION PROMPT FOR MOBILE PORTRAIT ── */}
      {isPortraitMobile && (
        <div className="absolute inset-0 z-[120] bg-black/95 backdrop-blur-xl flex flex-col items-center justify-center p-6 text-center text-white select-none animate-fadeIn" dir="rtl">
          ...
          <p className="text-sm text-purple-200/80 max-w-xs mb-8 leading-relaxed font-medium">
            للحصول على تجربة لعب حماسية بملء الشاشة وتحكم كامل مريح بالإبهامين 🎮
          </p>
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs">
            ...
            <button
              type="button"
              onClick={handleClose}
              className="w-full py-3 px-4 rounded-xl bg-white/10 hover:bg-white/15 active:scale-95 text-white/70 font-bold text-xs border border-white/10 flex items-center justify-center gap-1.5"
            >
