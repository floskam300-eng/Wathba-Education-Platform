...
const STAGE_COLORS = {
  'الصف الأول الابتدائي': 'bg-rose-50 text-rose-700',
  'الصف الثاني الابتدائي': 'bg-pink-50 text-pink-700',
  'الصف الثالث الابتدائي': 'bg-amber-50 text-amber-700',
  'الصف الرابع الابتدائي': 'bg-orange-50 text-orange-700',
  'الصف الخامس الابتدائي': 'bg-lime-50 text-lime-700',
  'الصف السادس الابتدائي': 'bg-yellow-50 text-yellow-700',
