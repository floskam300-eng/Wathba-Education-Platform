  ...
  return (
    <div className="space-y-5">
      <div className="page-header">
        <h1 className="text-xl sm:text-2xl font-black text-navy-600 dark:text-[var(--dk-text-1)] flex items-center gap-2">
          <BookMarked className="w-6 h-6 sm:w-7 sm:h-7 text-orange-500 flex-shrink-0" /> بنوك الأسئلة
          <span className="text-sm font-semibold text-gray-600 dark:text-[var(--dk-text-2)]">({banks.length})</span>
        </h1>
      ...
      <div className="bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-800/40 rounded-2xl p-4 text-sm text-orange-800 dark:text-orange-300 font-medium">
          ...
          {banks.map(bank => (
            <div key={bank.id} className="card !p-0 overflow-hidden">
              <div className="p-3 sm:p-4 flex items-start sm:items-center gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-navy-600 to-navy-800 rounded-xl flex items-center justify-center flex-shrink-0">
                  <BookMarked className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="font-black text-navy-700 dark:text-[var(--dk-text-1)] text-base sm:text-lg">{bank.name}</h3>
                  <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                    {bank.course_name && (
                      <span className="flex items-center gap-1 px-2 py-0.5 bg-orange-100 dark:bg-orange-950/50 text-orange-700 dark:text-orange-300 rounded-full text-xs font-bold">
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs sm:text-sm font-black transition-all bg-orange-50 hover:bg-orange-500 hover:text-white text-orange-700 border border-orange-200 hover:border-orange-500 flex-shrink-0 dark:bg-orange-950/30 dark:text-orange-300 dark:border-orange-800/40">
