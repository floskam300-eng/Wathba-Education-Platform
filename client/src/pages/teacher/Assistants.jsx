...
const emptyForm = { username: '', password: '', name: '', phone: '', can_add_students: true, can_edit_students: true, can_delete_students: false, can_manage_exams: true, can_manage_recitations: false, can_view_analytics: true, can_manage_payments: false, can_manage_courses: false, can_send_notifications: false };
