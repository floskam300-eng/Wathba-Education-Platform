...
async function seed() {
  ...
  const studentsData = [
    ...
    ['std_mostafa', 'مصطفى أسامة نور',       '+201200000025', '+201200000026', 'الصف الثاني الثانوي عام', 'ذكر',   340, false],
    ['std_rana',    'رنا طارق عبد العزيز',   '+201200000027', '+201200000028', 'الصف الثاني الثانوي بكالوريا', 'أنثى',  420, false],
    ['std_adam',    'آدم محمود صلاح',        '+201200000029', '+201200000030', 'الصف الثاني الثانوي عام', 'ذكر',   295, false],
    ['std_lina',    'لينا سعيد القاضي',      '+201200000031', '+201200000032', 'الصف الثاني الثانوي بكالوريا', 'أنثى',  380, false],
    ['std_hana',    'هناء وليد منصور',       '+201200000033', '+201200000034', 'الصف الأول الثانوي عام',  'أنثى',  150, false],
    ['std_hassan',  'حسن علاء طارق',         '+201200000035', '+201200000036', 'الصف الأول الثانوي بكالوريا',  'ذكر',   190, false],
  ];
  ...
  const [c4] = await q(`
    ...
    VALUES (
      ...
      200,$1,'الصف الثاني الثانوي عام',true,false,40,
  ...
  const [c6] = await q(`
    ...
    VALUES (
      ...
      0,$1,'الصف الثاني الثانوي بكالوريا',true,true,15,
      'https://images.unsplash.com/photo-1596495578065-6e0763fa1178?w=600&h=340&fit=crop')
    RETURNING id
  `, [T1]);
...
// (أول تسجيل دخول من المتصفح سيُضاف كجهازه الوحيد — مسموح بجهاز واحد فقط)
