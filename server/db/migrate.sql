...
-- Convert exams, recitations, and live streams date columns to TIMESTAMPTZ to avoid timezone shifts
ALTER TABLE exams ALTER COLUMN start_date TYPE TIMESTAMPTZ;
ALTER TABLE exams ALTER COLUMN end_date TYPE TIMESTAMPTZ;
