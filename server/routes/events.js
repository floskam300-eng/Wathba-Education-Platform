...
const GAME_CATALOG = [
  ...
  },
  {
    id: 'space_blaster',
    title: 'صائد الفضاء',
    subtitle: 'حلق بسفينتك الفضائية، دمر الكويكبات بالليزر واشحن مدفع الطاقة بالأسئلة!',
    icon: '🚀',
    category: 'arcade',
    badge: 'أكشن ومغامرة',
    ...
    rules: [
      ...
      'Space أو زر الليزر لإطلاق قذائف الليزر',
      'دمر الكويكبات واجمع النقاط',
      'أجب عن سؤال الزعيم لإطلاق ضربة الليزر القاضية'
    ]
  },
  {
    id: 'tower_of_riddles',
